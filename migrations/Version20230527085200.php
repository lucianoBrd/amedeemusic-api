 ...
 */
final class Version20230527085200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mail (id INT AUTO_INCREMENT NOT NULL, mail_content_id INT DEFAULT NULL, title VARCHAR(500) DEFAULT NULL, recipients_string LONGTEXT DEFAULT NULL, date DATETIME NOT NULL, template VARCHAR(255) DEFAULT NULL, sent TINYINT(1) NOT NULL, INDEX IDX_5126AC4850634911 (mail_content_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
